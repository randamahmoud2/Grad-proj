  ...
  return (
    <ToothProvider>
        <div id="vr_charting" style={{ width: '100%', height: '100%',overflow: "auto"  }}>
          ...
          <Table1Up id="0" id2="1" style={{ width: '100%' }} patientChartManager={patientChartManager} />
          <Table1Down id="1" id2="0" style={{ width: '100%' }} patientChartManager={patientChartManager} />
          <Table2Up id="2" id2="3" style={{ width: '100%' }} patientChartManager={patientChartManager} />
          <Table2Down id="3" id2="2" style={{ width: '100%' }} patientChartManager={patientChartManager} />
        </div>
      </div>
    </ToothProvider>
  );
