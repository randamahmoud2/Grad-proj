...
import { FaEnvelope, FaPhone, FaVenusMars, FaCalendarAlt, FaDollarSign, FaBriefcase, FaInfoCircle } from 'react-icons/fa'
...
export const Profile = () => {
    ...
    useEffect(() => {
        ...
        // Initial dummy structure to show layout (optional):
        setUserData({
            id: null,
            image: user,
            name: '',
