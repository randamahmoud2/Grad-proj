...
const Appointment = () => {
    ...
    // Fetch doctor data and available slots when component mounts
    useEffect(() => {
    ...
    const getAvailableTimeSlots = () => {
        ...
        return availableSlots
            .filter(slot => 
                ...
                slot.isAvailable === true // Ensure only available slots are shown
            )
                            ...
                            <div className="time1">
                                {getAvailableTimeSlots().length > 0 ? (
                                    getAvailableTimeSlots().map((time, index) => (
                                        <button
                                            key={index}
                                            className={`button ${selectedTime === time ? "selected" : ""}`}
